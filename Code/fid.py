...
from imageio import imread # previously "from scipy.misc import imread", but bugged now
...
if __name__ == "__main__":
    ...
    parser.add_argument("--output_dir", default="/network/home/jolicoea/Output/Extra", type=str,
